(function ($) {
  ...
  $(".wed_map_over").on("click", function (e) {
    $(this)
      .parents(".wed_section_outter, .wed_inside_map")
      .toggleClass("active_map");
  });
  ...
  $(".wed_header_search").on({
    mouseenter: function () {
      $(this)
        .find(".wed_header_search_cont, .wed_header_basket_cont")
        .stop()
        .fadeToggle();
    },
    mouseleave: function () {
  ...
  $("div[data-animation=animation_blocks]").each(function () {
    ...
    $(this)
      .find(
        ".wed_icon_box, .skill-bar-content, .wed_anim_box, .wed_bd, .wed_story_txt, .wed_portfolio_item_cont"
      )
      .each(function () {
